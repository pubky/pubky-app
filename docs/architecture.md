...
| [0017](adr/0017-runtime-config-injection.md)                 | Runtime config injection                     |
| [0018](adr/0018-runtime-sentry-and-decoupled-source-maps.md) | Runtime Sentry and decoupled source maps     |
| [0019](adr/0019-local-first-tag-cache.md)                    | Local-first tag cache and viewport lifetimes |
