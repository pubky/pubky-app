...
import { defaultSessionBridgeAllowedOrigins } from '@/libs/session-bridge/allowlist';
...
process.env.NEXT_PUBLIC_SESSION_BRIDGE_ALLOWED_ORIGINS = defaultSessionBridgeAllowedOrigins();
