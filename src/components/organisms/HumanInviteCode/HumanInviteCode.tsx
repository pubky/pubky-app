...
export const HumanInviteCode = ({ onBack, onVerify, onSuccess }: HumanInviteCodeProps) => {
  ...
  return (
    <React.Fragment>
      ...
      <Card data-testid="human-invite-code-card" className="gap-0 overflow-hidden p-6 lg:p-12">
        <Container className="mx-0 w-full flex-col gap-4 lg:flex-row lg:items-start lg:gap-12">
          <Container className="mx-0 hidden w-48 shrink-0 lg:block">
            <Image src="/images/gift.webp" alt="Gift" width={192} height={192} className="size-48 object-cover" />
          </Container>

          <Container className="mx-0 w-full min-w-0 flex-col gap-6 lg:max-w-xl lg:flex-1">
            <Container className="mx-0 flex-col gap-3">
              <Container className="mx-0 flex-row items-center gap-1">
            ...
            <Container className="mx-0 flex-col gap-6">
              <Container
                data-testid="human-invite-code-input-field"
                className={cn(
                  'mx-0 flex-row items-center gap-3 rounded-md border border-dashed bg-background/10 px-5 py-4 shadow-xs',
              ...
              <Container className="mx-0 flex-col items-center gap-4 sm:flex-row">
                <Button
                  variant="secondary"
