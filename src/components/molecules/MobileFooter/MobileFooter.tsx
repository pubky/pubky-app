...
export function MobileFooter({ className }: MobileFooterProps) {
  ...
  return (
    <div className={Libs.cn('flex justify-center pb-20 lg:hidden', className)}>
      <div
        className={Libs.cn(
          'fixed bottom-0 z-40 flex w-full max-w-[380px] items-center justify-between overflow-x-auto bg-linear-to-t from-background via-background/15 to-transparent px-3 py-4 sm:max-w-[600px] md:max-w-[720px]',
