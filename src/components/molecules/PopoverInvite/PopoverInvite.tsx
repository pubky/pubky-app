      ...
      <PopoverContent className="w-[327px]">
        <Container className="flex-col gap-6 px-3 py-2">
          ...
          <Container className="flex-row gap-4">
            <Link href={Config.EMAIL_URL} className="text-muted-foreground hover:text-brand">
              <Mail className="h-6 w-6" />
            </Link>
            <Link href={Config.TWITTER_URL} className="text-muted-foreground hover:text-brand">
              <XTwitter className="h-6 w-6" />
            </Link>
            <Link href={Config.TELEGRAM_URL} className="text-muted-foreground hover:text-brand">
