...
- **Stock Lucide**: `import { IconName } from 'lucide-react'` — never re-export the whole package from libs modules or other app barrels (`export * from 'lucide-react'` is forbidden).
