...
- AI-assisted development (Claude Code, Codex, Cursor): start at [AGENTS.md](./AGENTS.md); local review skill `/pubky-code-review` (`.agents/skills/pubky-code-review/SKILL.md`)
