...
// Sync
const result = Sentry.startSpan({ name: 'computeRecommendations', op: 'function' }, () => expensiveComputation());
```
...
Sentry.startSpan({ name: 'background-job', op: 'function', forceTransaction: true }, () => runBackgroundJob());
